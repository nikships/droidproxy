...
### Changed
- **Grok 4.6** -- The Factory custom model is now `custom:droidproxy:grok-4.6` (`grok-4.6`, 500k context). Re-applying Factory models replaces `custom:droidproxy:grok-4.5`. Cursor beta entries follow the same rename (`cursor-grok-4.6` / `cursor-grok-4.6-fast`).
