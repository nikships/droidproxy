...
export const providers: Provider[] = [
  ...
  { icon: '/assets/icon-gemini.png', name: 'Antigravity', lab: 'Google', note: 'Subscription', color: brandColor.gemini },
  ...
  { icon: '/assets/icon-junie.svg', name: 'Junie', lab: 'JetBrains', note: 'API key', color: brandColor.junie },
]
...
export const models: ModelRow[] = [
  ...
  },
  {
    ...
    name: 'Junie Fable 5.1',
    id: 'junie-claude-fable-5-1',
    levels: ['low', 'medium', 'high', 'xhigh', 'max'],
    max: '128,000',
    provider: 'JetBrains',
    group: 'Junie',
    color: brandColor.junie,
  },
  {
    icon: '/assets/icon-junie.svg',
    name: 'Junie Opus 5.5',
    id: 'junie-claude-opus-5-5',
    levels: ['low', 'medium', 'high', 'xhigh', 'max'],
    max: '128,000',
    provider: 'JetBrains',
    group: 'Junie',
