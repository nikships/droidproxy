...
const steps = [
  ...
  },
  {
    ...
    desc: 'Click Apply Factory Models once. Droid CLI grows a DroidProxy: … entry for every connected lab. Pick one with /model and every request hits localhost:8317, then the lab that bills the request.',
    portLabel: 'billed by',
    port: 'your AI lab',
  },
]
    ...
    <section id="how-it-works">
      <div className="container">
        <div className="section-head">
          ...
          <p>{noOrphan('DroidProxy lives in the menu bar. You authenticate through it, it writes custom models into Factory, and Droid keeps the same keyboard-first workflow — slash commands, skills, missions, diffs — on your existing plan.')}</p>
        </div>
        ...
        <div className="flow">
          {steps.map((s) => (
            <div className="flow-row" key={s.num}>
              ...
              <div className="flow-desc">{noOrphan(s.desc)}</div>
