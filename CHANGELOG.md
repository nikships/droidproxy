...
### Changed
- **Compact quota cards** -- **OAuth Quota Usage** is a grid of small per-account cards. Each quota window is a hollow ring gauge that drains as quota is used (green, orange below 25%, red below 10%) with percent left in the center; hover a ring for the reset time.
