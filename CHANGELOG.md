...
- **Stacked multi-limit rings** -- A subscription with more than one limit (e.g. 5-hour + weekly) stacks half-size rings vertically into a single spot, shorter window on top; hover still names each window.
